...
set output './tmp/imageData/_EuklidNorm(physVelocity)iT0001030.jpeg'
} else {set terminal png size 1920,1080font ",25"
set output './tmp/imageData/_EuklidNorm(physVelocity)iT0001030.png'
}
set pm3d map
unset key
set size ratio -1
...
splot './tmp/imageData/data/EuklidNorm(physVelocity).matrix' u ($1*0.00357143+-0.0238095):($2*0.00357143+-2.22045e-16):3 matrix with pm3d
