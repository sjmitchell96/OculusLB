...
const bool smagOn = false;
const bool bouzidiOn = true;
...
int main( int argc, char* argv[] ) {
  ...
  BGKdynamics<T, DESCRIPTOR> bulkDynamicsBGK( converter.getLatticeRelaxationFrequency(), instances::getBulkMomenta<T, DESCRIPTOR>() );
  SmagorinskyBGKdynamics<T, DESCRIPTOR> bulkDynamicsSmag( converter.getLatticeRelaxationFrequency(),
  ...
  if(smagOn){	
    prepareLattice( sLattice, converter, bulkDynamicsSmag, sBoundaryCondition, sOffBoundaryCondition, stlReader, superGeometry );
  }
  else{
    prepareLattice( sLattice, converter, bulkDynamicsBGK, sBoundaryCondition, sOffBoundaryCondition, stlReader, superGeometry );
  }
