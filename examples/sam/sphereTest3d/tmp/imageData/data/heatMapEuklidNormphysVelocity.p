...
set output './tmp/imageData/_EuklidNorm(physVelocity)iT0000000.jpeg'
} else {set terminal png size 1920,1080font ",25"
set output './tmp/imageData/_EuklidNorm(physVelocity)iT0000000.png'
}
set pm3d map
unset key
set size ratio -1
...
splot './tmp/imageData/data/EuklidNorm(physVelocity).matrix' u ($1*0.0007575+0.00225):($2*0.0007575+0.00225):3 matrix with pm3d
