...
set output './tmp/imageData/_csv_1_vorticityiT0000000.jpeg'
} else {set terminal png size 1920,1080font ",25"
set output './tmp/imageData/_csv_1_vorticityiT0000000.png'
}
set pm3d map
unset key
set size ratio -1
...
splot './tmp/imageData/data/csv_1_vorticity.matrix' u ($1*0.00102+0.1632):($2*0.00102+0.15912):3 matrix with pm3d
