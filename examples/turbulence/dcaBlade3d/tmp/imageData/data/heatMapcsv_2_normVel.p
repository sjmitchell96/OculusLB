...
set output './tmp/imageData/_csv_2_normVeliT0000000.jpeg'
} else {set terminal png size 1920,1080font ",25"
set output './tmp/imageData/_csv_2_normVeliT0000000.png'
}
set pm3d map
unset key
set size ratio -1
...
splot './tmp/imageData/data/csv_2_normVel.matrix' u ($1*0.00051+0.1836):($2*0.00051+0.17952):3 matrix with pm3d
