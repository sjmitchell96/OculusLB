...
set output './tmp/imageData/_csv_0_wsiT0000000.jpeg'
} else {set terminal png size 1920,1080font ",25"
set output './tmp/imageData/_csv_0_wsiT0000000.png'
}
set pm3d map
unset key
set size ratio -1
...
splot './tmp/imageData/data/csv_0_ws.matrix' u ($1*0.00204+0.00102):($2*0.00204+-5.55112e-17):3 matrix with pm3d
